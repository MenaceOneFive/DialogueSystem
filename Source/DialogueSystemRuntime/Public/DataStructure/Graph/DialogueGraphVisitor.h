 ...
 */
UINTERFACE()
class UDialogueGraphVisitor : public UInterface
{
    GENERATED_BODY()
};
...
public:
    ...
    virtual void VisitStartNode(UDialogueStartNode* StartNode) = 0;
    ...
    virtual void VisitSelectionNode(UDialogueSelectionNode* SelectionNode) = 0;
    ...
    virtual void VisitSceneNode(UDialogueSceneNode* SceneNode) = 0;
    ...
    virtual void VisitEndNode(UDialogueEndNode* EndNode) = 0;
    ...
    virtual void VisitEventNode(UDialogueEventNode* ScriptNode) = 0;
};


UCLASS()
class UDialogueGraphVisitorInstance : public UObject,
                                      public IDialogueGraphVisitor
{
    GENERATED_BODY()
...
public:
    ...
    virtual void VisitStartNode(UDialogueStartNode* StartNode) override;
    virtual void VisitSelectionNode(UDialogueSelectionNode* SelectionNode) override;
    virtual void VisitSceneNode(UDialogueSceneNode* SceneNode) override;
    virtual void VisitEndNode(UDialogueEndNode* EndNode) override;
    virtual void VisitEventNode(UDialogueEventNode* ScriptNode) override;
#pragma endregion
...
private:
    /// <summary>
    /// 현재 노드에서 다음 노드로 이동하는 헬퍼 메서드
    /// 
    /// 현재 노드의 NextNodeID를 사용하여 다음 노드를 찾고, 
    /// DialoguePositionController를 업데이트한 후 다음 노드의 VisitNode 메서드를 호출합니다.
    /// </summary>
    /// <param name="GraphNode">현재 그래프 노드</param>
    void VisitNextNode(const UDialogueGraphNode* GraphNode);
