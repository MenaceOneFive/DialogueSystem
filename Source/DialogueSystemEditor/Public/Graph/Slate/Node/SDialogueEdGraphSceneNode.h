...
/// <summary>
/// 대화 에디터 그래프의 장면 노드 Slate 위젯
/// <br>
/// 주의: SGraphNode::UpdateGraphNode()의 내용을 오버라이딩하지 말 것. <br>
/// SGraphNode::UpdateGraphNode()는 템플릿 메서드 패턴을 사용하고 있으므로,
/// 그 안에서 호출되는 CreateNodeContentArea(), GetNodeBodyBrush(), CreatePinWidgets() 등의 
/// 메서드를 오버라이드하여 구현하는 것을 권장함.
/// </summary>
class SDialogueEdGraphSceneNode final : public SGraphNode
{
public:
    SLATE_BEGIN_ARGS(SDialogueEdGraphSceneNode)
        {
        }
    ...
    /// <param name="SceneNode">장면 노드</param>
...
#pragma region ImplementationIsOptional
    ...
    /// <summary>
    /// 노드 제목을 표시하는 위젯을 생성합니다.
    /// 기본 제목 표시 방식을 변경하거나 추가적인 장식을 더하고 싶을 때 재정의합니다.
    /// </summary>
