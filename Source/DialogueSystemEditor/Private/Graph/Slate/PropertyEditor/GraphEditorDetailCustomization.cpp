...
TSharedRef<IDetailCustomization> FDialogueEdDialogueLineNodeDetail::MakeInstance()
{
    return MakeShareable(new FDialogueEdDialogueLineNodeDetail);
}

FDialogueEdDialogueLineNodeDetail::~FDialogueEdDialogueLineNodeDetail()
{
}
...
void FDialogueEdDialogueLineNodeDetail::OnDialogueLinePropertyChanged(TSharedPtr<IPropertyHandle> PropertyHandle)
{
...
#pragma region 위젯
void FDialogueEdDialogueLineNodeDetail::CreateDialogueLineTextBox(IDetailLayoutBuilder& DetailBuilder)
{
        ...
        DialogueLineHandle.IsUnique() )
    {
        ...
        DialogueLineHandle->SetOnPropertyValueChanged(FSimpleDelegate::CreateSP(this,
                                                                                &FDialogueEdDialogueLineNodeDetail::OnDialogueLinePropertyChanged,
                                                                                DialogueLineHandle));
...
FString FDialogueEdDialogueLineNodeDetail::GetDescription(IDetailLayoutBuilder& DetailBuilder)
{
    ...
    if ( SelectedObjectsList.Num() >= 1 )
    {
                ...
                Cast<UDialogueEdGraphDialogueLineNode>(SelectedObjectsList[0].Get()) )
        {
            ...
            {
                if ( UDialogueGraphAsset* DialogueGraphAsset = Cast<UDialogueGraphAsset>(Graph->GetOuter()) )
                {
...
void FDialogueEdDialogueLineNodeDetail::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
    // 현재 대사 텍스트 박스
    {
